...
public class SwitcherUser implements IUser {
    ...
    /* Constructor */
    public SwitcherUser (String em,String pass) {
        this.email = em;
        this.password = pass;
        first_name = "";
        last_name = "";
    ...
    /* Full Constructor*/
    public SwitcherUser (String em,String pass, String fn, String ln, String pn, String id) {
        this.email = em;
        this.password = pass;
        this.first_name = fn;
        this.last_name = ln;
